        ...
        >
          <div className="glass-panel p-10">
            <div className="flex flex-col items-center mb-8 text-center">
              ...
              <h2 className="text-3xl font-bold text-slate-900 dark:text-white">{t('auth.signupTitlePage')}</h2>
              <p className="text-slate-500 mt-2">{t('auth.signupDesc')}</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              <div>
                <label className="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-2">{t('auth.emailLabel')}</label>
              ...
              <div>
                <label className="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-2">{t('auth.passwordLabel')}</label>
                <div className="relative">
