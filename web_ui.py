...
def get_stats(chat_index: int):
    ...
    try:
        ...
        return jsonify({
            ...
            'daily_avg': sum(stats.get_daily_message_count().values()) / 
                        len(stats.get_daily_message_count()) if stats.get_daily_message_count() else 0
        })
